...
function Button({ className, variant = "default", size = "default", disabled, isDisabled, ...props }) {
    return (<ButtonPrimitive data-slot="button" data-variant={variant} data-size={size} isDisabled={isDisabled ?? disabled} className={cn(buttonVariants({ variant, size, className }))} {...props}/>);
}
function LinkButton({ className, variant = "default", size = "default", ...props }) {
