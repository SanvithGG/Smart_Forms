...
export function LandingPage({ onStartSurvey, onOpenEditor, onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar
        onLogin={onLogin}
        onStartSurvey={() => setIsPromptModalOpen(true)}
        onOpenEditor={() => onOpenEditor()}
      />
      <main>
        <HeroSection
          onStartSurvey={onStartSurvey}
          onOpenEditor={onLogin || (() => setIsPromptModalOpen(true))}
        />
        ...
        <PromptModal
          ...
          onGenerateAndOpenEditor={(generatedForm) => onOpenEditor(generatedForm)}
        />
      </main>
